...
type AuthClient interface {
	...
	IsAdminn(ctx context.Context, in *IsAdminRequest, opts ...grpc.CallOption) (*IsAdminResponce, error)
}
...
func (c *authClient) IsAdminn(ctx context.Context, in *IsAdminRequest, opts ...grpc.CallOption) (*IsAdminResponce, error) {
	out := new(IsAdminResponce)
	err := c.cc.Invoke(ctx, "/auth.Auth/IsAdminn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	IsAdminn(context.Context, *IsAdminRequest) (*IsAdminResponce, error)
...
func (UnimplementedAuthServer) IsAdminn(context.Context, *IsAdminRequest) (*IsAdminResponce, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IsAdminn not implemented")
}
...
func _Auth_IsAdminn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IsAdminRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).IsAdminn(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.Auth/IsAdminn",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).IsAdminn(ctx, req.(*IsAdminRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "IsAdminn",
			Handler:    _Auth_IsAdminn_Handler,
		},
	},
